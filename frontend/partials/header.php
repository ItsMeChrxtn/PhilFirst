...
<header class="bg-white border-b sticky top-0 z-50 shadow-sm">
  <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
    ...
    <nav class="hidden md:flex items-center gap-8 text-sm font-semibold">
      <a href="https://lavender-starling-358802.hostingersite.com/frontend/" class="hover:text-emerald-700">Home</a>
      <a href="jobs.php" class="hover:text-emerald-700">Careers</a>
      <?php if(!empty($_SESSION['user'])): ?>
        <a href="my_applications.php" class="hover:text-emerald-700">My Applications</a>
      <?php endif; ?>
      <div class="relative">
        ...
        <div id="aboutDropdown" class="absolute right-0 mt-2 w-64 bg-white border rounded shadow-lg hidden z-50">
          <a href="index.php#why" class="block px-4 py-2 hover:bg-neutral-100">Why Human Resources is Important?</a>
          <a href="index.php#team" class="block px-4 py-2 hover:bg-neutral-100">Who We Are?</a>
          <a href="index.php#about" class="block px-4 py-2 hover:bg-neutral-100">Our Code of Ethics</a>
          <a href="index.php#how" class="block px-4 py-2 hover:bg-neutral-100">How It Works – Recruitment and Selection Criteria</a>
        </div>
      </div>
      <a href="https://lavender-starling-358802.hostingersite.com/frontend/#services" class="hover:text-emerald-700">Services</a>
      <a href="https://lavender-starling-358802.hostingersite.com/frontend/#contact" class="hover:text-emerald-700">Contact</a>
    </nav>
  ...
  <div id="mobileNav" class="md:hidden hidden border-t bg-white">
    <div class="px-4 pt-4 pb-6 space-y-1">
      <a href="https://lavender-starling-358802.hostingersite.com/frontend/" class="block px-3 py-2 rounded hover:bg-neutral-100">Home</a>
      <a href="jobs.php" class="block px-3 py-2 rounded hover:bg-neutral-100">Careers</a>
      <div>
        ...
        <div id="mobileAboutDropdown" class="hidden pl-4 mt-1 space-y-1">
          <a href="index.php#why" class="block px-3 py-2 rounded hover:bg-neutral-100">Why Human Resources is Important?</a>
          <a href="index.php#team" class="block px-3 py-2 rounded hover:bg-neutral-100">Who We Are?</a>
          <a href="index.php#about" class="block px-3 py-2 rounded hover:bg-neutral-100">Our Code of Ethics</a>
          <a href="index.php#how" class="block px-3 py-2 rounded hover:bg-neutral-100">How It Works – Recruitment and Selection Criteria</a>
        </div>
      </div>
      <?php if(!empty($_SESSION['user'])): ?>
        <a href="my_applications.php" class="block px-3 py-2 rounded hover:bg-neutral-100">My Applications</a>
        <a href="settings.php" class="block px-3 py-2 rounded hover:bg-neutral-100">Settings</a>
      <?php else: ?>
        <a href="settings.php" class="hidden"></a>
      <?php endif; ?>
      <a href="#services" class="block px-3 py-2 rounded hover:bg-neutral-100">Services</a>
      <a href="#contact" class="block px-3 py-2 rounded hover:bg-neutral-100">Contact</a>
    </div>
  </div>
</header>
