...
try{
    ...
    @file_put_contents(__DIR__ . '/error.log', date('c') . ' mark_notifications_read error: ' . $e->getMessage() . PHP_EOL, FILE_APPEND | LOCK_EX);
